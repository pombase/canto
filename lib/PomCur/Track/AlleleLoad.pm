package PomCur::Track::AlleleLoad;

=head1 NAME

PomCur::Track::AlleleLoad - Code for loading allele information into
                            the TrackDB
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc PomCur::Track::AlleleLoad
...
=head2 load
 ...
 Usage   : my $allele_load = PomCur::Track::AlleleLoad->new(schema => $schema);
