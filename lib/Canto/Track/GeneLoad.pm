package Canto::Track::GeneLoad;

=head1 NAME

Canto::Track::GeneLoad - Code for loading gene information into a TrackDB
...
=head2 load
 ...
 Usage   : my $gene_load = Canto::Track::GeneLoad->new(schema => $schema);
