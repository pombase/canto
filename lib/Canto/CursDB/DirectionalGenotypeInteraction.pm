use utf8;
package Canto::CursDB::DirectionalGenotypeInteraction;
...
=head1 TABLE: C<directional_genotype_interaction>

=cut

__PACKAGE__->table("directional_genotype_interaction");

=head1 ACCESSORS

=head2 directional_genotype_interaction_id
...
__PACKAGE__->add_columns(
  "directional_genotype_interaction_id",
...
=item * L</directional_genotype_interaction_id>

=back

=cut

__PACKAGE__->set_primary_key("directional_genotype_interaction_id");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:cEVheNS7KjKW7B19UKZgBg
